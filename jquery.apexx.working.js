          ...
          if (mq.matches) { // window width is at least 900px
            ...
            function cycleItems() {
              ...
              for (var i=0;i<o.maxSlides;i++) {
                ...
                var itemID = (i + 1) > (itemAmt - o.maxSlides) ?  currentIndex - o.maxSlides + i : currentIndex + i;
                currentItems.push( items.eq(itemID) );
                if ((currentIndex + 1) > (itemAmt - o.maxSlides) ) {

                  console.log( Math.abs( (currentIndex + 1 - (o.maxSlides - i)) ) );
                }
                /*
                if ( (currentIndex + 1) > (itemAmt - o.maxSlides + 1) ) {
Math.abs( (currentIndex + 1 - (o.maxSlides - i)) )
                  currentItems.push( items.eq( (currentIndex + 1) > itemAmt ? (currentIndex - (o.maxSlides - i)) : currentIndex + i ) );
                } else {
              ...
              for (var i=0;i<currentItems.length;i++) {
                var leftValue = (( 100 / o.maxSlides) * i).toFixed(2);
                currentItems[i].addClass('active').css("left", "" + leftValue + "%");
              }
